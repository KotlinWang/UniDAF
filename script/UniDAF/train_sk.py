    ...
    def training(self):
        ...
        for epoch in range(self.epochs):
            ...
            if val_mIoU > best_mIoU:
                self.fabric.save(os.path.join(self.model_save_path, f'best_sk_model.pth'), self.stu_model.state_dict())
                best_mIoU = val_mIoU
                best_round = {
                    'best iter': epoch + 1,
                ...
                self.fabric.save(os.path.join(self.model_save_path, f'last_sk_model.pth'), self.stu_model.state_dict())
