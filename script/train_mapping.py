...
from UniDAF_mapping.train_change import change_main
from UniDAF_mapping.train_sk import sk_main
...
def main():
    ...
    model_save_dir = './saved_weights/AegisDA/mapping_20260206_111909'
