...
class Trainer(object):
    ...
    def __init__(self, args):
        ...
        with self.fabric.device:
            ...
            self.deep_model = DamageFormer(post_in_channels=6)
    ...
    def training(self):
        ...
        for epoch in range(self.epochs):
            ...
            for i, data in enumerate(loop):
                ...
                loc_output, clf_output = self.deep_model(pre_change_imgs, post_change_imgs) # If you use SiamCRNN 
    ...
    def validation(self):
        ...
        with torch.no_grad():
            ...
            for data in loader:
                ...
                post_change_imgs = torch.cat([post_opt_change_imgs, post_sar_change_imgs], dim=1)
                _, clf_output = self.deep_model(pre_change_imgs, post_change_imgs)
...
def main():
    ...
    parser.add_argument('--model_type', type=str, default='change/damageformer')
