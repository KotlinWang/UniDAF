...
from model.CDMamba import CDMamba
...
class Trainer(object):
    ...
    def __init__(self, args):
        ...
        with self.fabric.device:
            ...
            self.deep_model = CDMamba(spatial_dims=2, in_channels=3, init_filters=16, out_channels=4,
                                      mode="AGLGF", conv_mode="orignal_dinner", up_mode="SRCM", up_conv_mode="deepwise", norm=["GROUP", {"num_groups": 8}],
                                      blocks_down=[1, 2, 2, 4], blocks_up=[1, 1, 1], resdiual=False, diff_abs="later", stage=2,
                                      mamba_act="relu", local_query_model="orignal_dinner",)
        ...
        for epoch in range(self.epochs):
            ...
            for i, data in enumerate(loop):
                ...
                if not valid_labels_clf:
                    continue
                clf_output = self.deep_model(pre_change_imgs, post_opt_change_imgs, post_sar_change_imgs) # If you use SiamCRNN 

                final_loss = self.seg_loss(clf_output, labels_clf)
    ...
    def validation(self):
        ...
        with torch.no_grad():
            ...
            for data in loader:
                ...
                clf_output = self.deep_model(pre_change_imgs, post_opt_change_imgs, post_sar_change_imgs)
...
def main():
    ...
    parser.add_argument('--model_type', type=str, default='change/cdmamba')
