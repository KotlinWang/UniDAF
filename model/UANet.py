...
class UANet_pvt(nn.Module):
    def __init__(self, backbone, in_channel, channel, num_classes):
        super(UANet_pvt, self).__init__()
        self.backbone = timm.create_model(backbone, in_chans=in_channel, features_only=True, pretrained=True)
