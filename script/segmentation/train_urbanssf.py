...
from model.urbanssf_s.umamba_s import UMamba
...
class Trainer(object):
    ...
    def __init__(self, args):
        ...
        with self.fabric.device:
            ...
            self.deep_model = UMamba(backbone_name='resnet18.fb_swsl_ig1b_ft_in1k', in_channel=9, num_classes=4) 
    ...
    def training(self):
        ...
        for epoch in range(self.epochs):
            ...
            for i, data in enumerate(loop):
                ...
                labels_32 = Resize(to_2tuple(self.args.crop_size // 32), interpolation=InterpolationMode.NEAREST, antialias=True)(labels_clf)
                final_loss = self.seg_loss(clf_output, labels_clf) + 0.75*self.seg_loss(aux_output, labels_32)
...
def main():
    ...
    parser.add_argument('--model_type', type=str, default='segmention/urbanssf')
