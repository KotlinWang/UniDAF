...
class SiamCRNN(nn.Module):
    def __init__(self, sar_in_channels=6):
        super(SiamCRNN, self).__init__()
        expansion = 1

        self.encoder_1 = models.resnet18(weights=models.ResNet18_Weights.IMAGENET1K_V1)
        self.encoder_2 = models.resnet18(weights=models.ResNet18_Weights.IMAGENET1K_V1)
        return_nodes = {
            'layer1': 'feat1',
            'layer2': 'feat2',
            'layer3': 'feat3',
        ...
        if sar_in_channels != 3:
            self.extractor_2.conv1 = nn.Conv2d(sar_in_channels, 64, kernel_size=7, stride=2, padding=3, bias=False)
