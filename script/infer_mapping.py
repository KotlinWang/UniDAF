...
class Inference:
    def __init__(self, args):
        ...
        # Load dataset
        dataset = MultimodalDamageAssessmentDatset(args.val_dataset_path, args.val_data_name_list, 1024, 'test', suffix='.tif', mapping=True)
        ...
        self.model = Change('pvt_v2_b3.in1k', 2, 4, 128) 
...
if __name__ == "__main__":
    ...
    parser.add_argument('--val_dataset_path', type=str, default='/shared/kotlin/DATASET/AegisDA')
    parser.add_argument('--val_data_list_path', type=str, default='/shared/kotlin/DATASET/AegisDA/LA_WildFire/target_domain.txt')
    # parser.add_argument('--val_data_list_path', type=str, default='/shared/kotlin/DATASET/AegisDA/LA_WildFire/target_domain.txt')
    parser.add_argument('--val_data_name_list', type=list)
    parser.add_argument('--existing_weight_path', type=str,
                        default='./saved_weights/AegisDA/mapping_20260206_111909/best_sk_model.pth')
    parser.add_argument('--inferece_saved_path', type=str, default='./inference_results/mapping')
