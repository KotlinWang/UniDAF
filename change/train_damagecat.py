...
from model.DamageCAT.DamageCAT import BASE_Transformer_UNet
...
class Trainer(object):
    ...
    def __init__(self, args):
        ...
        with self.fabric.device:
            ...
            self.deep_model = BASE_Transformer_UNet(
                backbone='resnet18.fb_swsl_ig1b_ft_in1k', input_nc=6, output_nc=4,
                token_len=4, resnet_stages_num=4, with_pos="learned", with_decoder_pos="learned",
        ...
        for epoch in range(self.epochs):
            ...
            for i, data in enumerate(loop):
                ...
                if not valid_labels_clf:
                    continue
                post_change_imgs = torch.cat([post_opt_change_imgs, post_sar_change_imgs], dim=1)
                clf_output = self.deep_model(pre_change_imgs, post_change_imgs) # If you use SiamCRNN 
    ...
    def validation(self):
        ...
        with torch.no_grad():
            ...
            for data in loader:
                ...
                post_change_imgs = torch.cat([post_opt_change_imgs, post_sar_change_imgs], dim=1)
                clf_output = self.deep_model(pre_change_imgs, post_change_imgs)
...
def main():
    ...
    parser.add_argument('--model_type', type=str, default='change/damagecat')
