...
from model.ChangeFormer.ChangeFormer import ChangeFormerV6
...
class Trainer(object):
    ...
    def __init__(self, args):
        ...
        with self.fabric.device:
            ...
            self.deep_model = ChangeFormerV6(output_nc=4)
    ...
    def training(self):
        ...
        for epoch in range(self.epochs):
            ...
            for i, data in enumerate(loop):
                ...
                final_loss = self.seg_loss(clf_output[-1], labels_clf)
...
def main():
    ...
    parser.add_argument('--model_type', type=str, default='change/changeformer')
